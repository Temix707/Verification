...
create_clock -add -name clk_100m -period 10.00 -waveform {0 5} [get_ports {CLK100MHZ}];
...
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { LED[5] }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
