...
HD_PWD='C:/Vivado_project/JOB_projects/trash_projects/check_xdc/check_xdc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shell_check.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shell_check.tcl -notrace
