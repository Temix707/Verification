...
HD_PWD='C:/Vivado_project/JOB_projects/trash_projects/check_xdc/check_xdc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shell_check.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shell_check.tcl
